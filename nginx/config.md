...
- [1. 基本结构](#1-基本结构)
  - [1.1 基于域名的虚拟主机](#11-基于域名的虚拟主机)
  - [1.2 基于端口的虚拟主机配置](#12-基于端口的虚拟主机配置)
- [2. log 日志管理](#2-log-日志管理)
  - [2.1 main日志格式](#21-main日志格式)
  - [2.2 自定义日志格式](#22-自定义日志格式)
  - [2.3 日志按日期备份存储 ———— shell+定时任务+nginx信号管理](#23-日志按日期备份存储--shell定时任务nginx信号管理)
- [3. location 定位](#3-location-定位)
  - [3.1 命中规则](#31-命中规则)
  - [3.2 例子1：精准命中和普通命中](#32-例子1精准命中和普通命中)
  - [3.2 例子2：普通命中和正则命中](#32-例子2普通命中和正则命中)
  - [3.3 例子3: 普通命中](#33-例子3-普通命中)
- [4. rewrite 重定向](#4-rewrite-重定向)
  - [4.1 if](#41-if)
  - [4.2 rewrite语法](#42-rewrite语法)
- [5. gzip 压缩传输优化](#5-gzip-压缩传输优化)
- [6. expires 缓存设置](#6-expires-缓存设置)
  - [**如果信息流动比较快,也可以不用expires指令, 用last_modified, etag, 304功能，也是一种很好的缓存手段**](#如果信息流动比较快也可以不用expires指令-用last_modified-etag-304功能也是一种很好的缓存手段)
- [7. proxy 反向代理](#7-proxy-反向代理)
- [8. upstream 负载均衡](#8-upstream-负载均衡)
  - [8.1 负载均衡的具体方式](#81-负载均衡的具体方式)
  - [8.2 nginx负载均衡](#82-nginx负载均衡)
